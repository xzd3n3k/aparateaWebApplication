    ...
    return (
        <div className="about-container">
            ...
            <div className="about-content">
                ...
                <div className="about-content-text">
                    <p>Již roky <b className="">spolupracujeme s velkým počtem odborných firem</b> zabývajících se zpracováním dřeva, a to nejen v České republice, ale v celé Evropě.</p>
                    <p>Poslední <b className="">roky expandujeme </b>a snažíme se pro Vás zlepšovat náš servis a dostupnost, abychom Vám mohli být na blízko v každé situaci.</p>
                </div>
                ...
                <div className="about-content-text">
                    <p><b>Nejvýznamnější událostí</b> každého roku je <b>mezinárodní veletrh strojů a nářadí DREMA</b> pro dřevařský a nábytkářský průmysl v Poznani. Jsme hrdí na to, že můžeme představit další <b>nové značky</b>, které se připojily k našemu portfoliu produktů.</p>
                    <p>Již několik let je náš stánek <b>oceněn cenou Acanthus Aureus</b>. Soška se uděluje subjektům, jejichž postavení <b>nejlépe odráží marketingovou strategii společnosti</b>.</p>
                </div>
